...
class Styles
{
	...
	public function new() {
		...
		WHITE24 = new TextFormat(Assets.getFont("fonts/PressStart2P-Regular.ttf").fontName, 24, 0x000000);
		WHITE16 = new TextFormat(Assets.getFont("fonts/PressStart2P-Regular.ttf").fontName, 16, 0x000000);
		WHITE12 = new TextFormat(Assets.getFont("fonts/PressStart2P-Regular.ttf").fontName, 12, 0x000000);
	}
}